...
<section class="form-container">
   ...
   <form action="" method="post">
      ...
      <input type="tel" name="name" required maxlength="50" placeholder="entrez votre nom" class="box">
      <input type="email" name="email" required maxlength="50" placeholder="entrez votre email" class="box">
      <input type="number" name="number" required min="0" max="9999999999" maxlength="10" placeholder="entrez votre numéro" class="box">
      ...
      <p>vous avez déjà un compte ? <a href="login.php">login maintenant</a></p>
