...
<section class="my-listings">
   ...
   <form accept="" method="POST" class="box">
      ...
      <div class="price"><?= $fetch_property['price']; ?>DH</span></div>
      <h3 class="name"><?= $fetch_property['property_name']; ?></h3>
      <p class="location"><i class="fas fa-map-marker-alt"></i><span><?= $fetch_property['address']; ?></span></p>
      <div class="flex-btn">
         <a href="update_property.php?get_id=<?= $property_id; ?>" class="btn">misàjour</a>
         <input type="submit" name="delete" value="supprimer" class="btn" onclick="return confirm('delete this listing?');">
      </div>
      <a href="view_property.php?get_id=<?= $property_id; ?>" class="btn">voir la propriété</a>
   </form>
   <?php
         }
      }else{
         echo '<p class="empty">aucune propriété ajoutée!<a href="post_property.php" style="margin-top:1.5rem;" class="btn">ajouter un nouveau</a></p>';
      }
      ?>
