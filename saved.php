...
<section class="listings">
   ...
   <h1 class="heading">annonces enregistrées</h1>
   ...
   <div class="box-container">
      ...
      <form action="" method="POST">
         <div class="box">
            ...
            ?>
            <button type="submit" name="save" class="save"><i class="fas fa-heart"></i><span>supprimer de l'enregistrement</span></button>
            <?php
               }else{ 
            ?>
         ...
         <div class="box">
            <div class="price"><span><?= $fetch_property['price']; ?></span>DH</div>
