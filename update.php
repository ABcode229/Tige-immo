...
<section class="form-container">
   ...
   <form action="" method="post">
      <h3>mettez à jour votre compte !</h3>
      ...
      <input type="password" name="old_pass" maxlength="20" placeholder="entrez votre ancien mot de passe" class="box">
      <input type="password" name="new_pass" maxlength="20" placeholder="entrez votre nouveau mot de passe" class="box">
      <input type="password" name="c_pass" maxlength="20" placeholder="confirmez votre nouveau mot de passe" class="box">
