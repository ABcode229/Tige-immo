...
<section class="requests">
   ...
   <h1 class="heading">toutes les demandes</h1>
   ...
   <div class="box">
      ...
      <form action="" method="POST">
         ...
         <input type="submit" value="supprimer la demande" class="btn" onclick="return confirm('remove this request?');" name="delete">
   ...
   <?php
      ...
      echo '<p class="empty">vous navez aucune demande !</p>';
   }
   ?>
