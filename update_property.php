...
<section class="property-form">
   ...
   <form action="" method="POST" enctype="multipart/form-data">
      ...
      <div class="box">
         ...
         <input type="text" name="property_name" required maxlength="50" placeholder="entrez le nom de la propriété" value="<?= $fetch_property['property_name']; ?>" class="input">
      </div>
      <div class="flex">
         <div class="box">
            <p>prix de l'immobilier <span>*</span></p>
            <input type="number" name="price" required min="0" max="9999999999" maxlength="10" value="<?= $fetch_property['price']; ?>" placeholder="saisir le prix de la propriété" class="input">
         </div>
         <div class="box">
            <p>montant du dépôt<span>*</span></p>
            <input type="number" name="deposite" required min="0" max="9999999999" value="<?= $fetch_property['deposite']; ?>" maxlength="10" placeholder="saisir le montant du dépôt" class="input">
         </div>
         <div class="box">
            <p>adresse de la propriété <span>*</span></p>
            <input type="text" name="address" required maxlength="100" placeholder="entrez l'adresse complète de la propriété" class="input" value="<?= $fetch_property['address']; ?>">
         </div>
         <div class="box">
         ...
         <div class="box">
            <p>statut de propriété <span>*</span></p>
            <select name="status" required class="input">
               <option value="<?= $fetch_property['status']; ?>" selected><?= $fetch_property['status']; ?></option>
               <option value="ready to move">prêt à déménager</option>
               <option value="under construction">en cours de construction</option>
            </select>
         </div>
         <div class="box">
         ...
         <div class="box">
            <p>combien de salles de bains <span>*</span></p>
         ...
         <div class="box">
            ...
            <select name="balcony" required class="input">
               ...
               <option value="0">0 balcons</option>
               <option value="1">1 balcons</option>
         ...
         <div class="box">
            <p>zone de tapis <span>*</span></p>
            <input type="number" name="carpet" required min="1" max="9999999999" maxlength="10" placeholder="combien de carrés ?" class="input" value="<?= $fetch_property['carpet']; ?>">
         </div>
         <div class="box">
            <p>âge de la propriété <span>*</span></p>
            <input type="number" name="age" required min="0" max="99" maxlength="2" placeholder="quel âge a la propriété ?" class="input" value="<?= $fetch_property['age']; ?>">
         </div>
         <div class="box">
            <p>étages totaux<span>*</span></p>
            <input type="number" name="total_floors" required min="0" max="99" maxlength="2" placeholder="combien d'étages sont disponibles ?" class="input" value="<?= $fetch_property['total_floors']; ?>">
         </div>
         <div class="box">
            <p>chambre à l'étage <span>*</span></p>
            <input type="number" name="room_floor" required min="0" max="99" maxlength="2" placeholder="numéro d'étage de la propriété" class="input" value="<?= $fetch_property['room_floor']; ?>">
         </div>
         <div class="box">
            <p>prêt <span>*</span></p>
            <select name="loan" required class="input">
               ...
               <option value="not available" >pas disponible</option>
            </select>
         </div>
      </div>
      <div class="box">
         <p>description de la propriété <span>*</span></p>
         <textarea name="description" maxlength="1000" class="input" required cols="30" rows="10" placeholder="écrire sur la propriété..." ><?= $fetch_property['description']; ?></textarea>
      </div>
      <div class="checkbox">
         <div class="box">
      ...
      <div class="box">
         ...
         <input type="submit" value="delete image 01" name="delete_image_01" class="inline-btn" onclick="return confirm('delete image 01');">
         <p>mise à jour image 01</p>
      ...
      <div class="flex"> 
         ...
         <div class="box">
            ...
            <?php } ?>
            <p>mise à jour image 05</p>
            <input type="file" name="image_05" class="input" accept="image/*">
         </div>   
      </div>
      <input type="submit" value="mettre à jour la propriété" class="btn" name="update">
   </form>
   <?php
      }
   }else{
