...
<section class="filters" style="padding-bottom: 0;">
   ...
   <form action="" method="post">
      ...
      <h3>filter la recherche</h3>
         
         <div class="flex">
            <div class="box">
               <p>entrez l'emplacement</p>
               <input type="text" name="location" required maxlength="50" placeholder="entrez le nom de la ville" class="input">
            </div>
            <div class="box">
               <p>type d'offre</p>
         ...
         <input type="submit" value="rechercher une propriété" name="filter_search" class="btn">
   </form>
...
<section class="listings">
   ...
   <?php 
      if(isset($_POST['h_search']) or isset($_POST['filter_search'])){
         echo '<h1 class="heading">résultats de recherche</h1>';
      }else{
         echo '<h1 class="heading">toutes les annonces</h1>';
      }
   ?>
