...
<section class="property-form">
   ...
   <form action="" method="POST" enctype="multipart/form-data">
      ...
      <div class="box">
         ...
         <input type="text" name="property_name" required maxlength="50" placeholder="entrez le nom de la propriété" class="input">
      </div>
      <div class="flex">
         <div class="box">
            <p>prix de l'immobilier <span>*</span></p>
            <input type="number" name="price" required min="0" max="9999999999" maxlength="10" placeholder="saisir le prix de la propriété" class="input">
         </div>
         <div class="box">
            <p>montant du dépôt<span>*</span></p>
            <input type="number" name="deposite" required min="0" max="9999999999" maxlength="10" placeholder="saisir le montant du dépôt" class="input">
         </div>
         <div class="box">
            <p>adresse de la propriété <span>*</span></p>
            <input type="text" name="address" required maxlength="100" placeholder="entrez l'adresse complète de la propriété" class="input">
         </div>
         <div class="box">
         ...
         <div class="box">
            ...
            <select name="bedroom" required class="input">
               ...
               <option value="1" selected>1 chambres</option>
         ...
         <div class="box">
            ...
            <input type="number" name="carpet" required min="1" max="9999999999" maxlength="10" placeholder="combien de carrés ?" class="input">
         </div>
         <div class="box">
            <p>âge de la propriété<span>*</span></p>
            <input type="number" name="age" required min="0" max="99" maxlength="2" placeholder="quel âge a la propriété ?" class="input">
         </div>
         <div class="box">
            <p>étages totaux <span>*</span></p>
            <input type="number" name="total_floors" required min="0" max="99" maxlength="2" placeholder="combien d'étages sont disponibles ?" class="input">
         </div>
         <div class="box">
            <p>chambre à l'étage <span>*</span></p>
            <input type="number" name="room_floor" required min="0" max="99" maxlength="2" placeholder="numéro d'étage de la propriété" class="input">
         </div>
         <div class="box">
            <p>prêt <span>*</span></p>
      ...
      <div class="checkbox">
         <div class="box">
            ...
            <p><input type="checkbox" name="security_guard" value="yes" /> agents de sécurité</p>
            <p><input type="checkbox" name="play_ground" value="yes" />aire de jeux</p>
            <p><input type="checkbox" name="garden" value="yes" />jardins</p>
         ...
         <div class="box">
            <p><input type="checkbox" name="parking_area" value="yes" />aire de stationnement</p>
            <p><input type="checkbox" name="gym" value="yes" />salle de sport</p>
            <p><input type="checkbox" name="shopping_mall" value="yes" />centre commercial_mall</p>
            <p><input type="checkbox" name="hospital" value="yes" />hôpital</p>
            <p><input type="checkbox" name="school" value="yes" />écoles</p>
